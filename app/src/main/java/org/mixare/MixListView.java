...
public class MixListView extends ListActivity {
	...
	// 자체 주소로 사용될 커스텀 URL
	public static String customizedURL = "http://ec2-13-124-56-231.ap-northeast-2.compute.amazonaws.com/connect.php";
	...
	public void onCreate(Bundle savedInstanceState){
		...
		case 1:	// 데이터 소스를 선택하는 리스트			
			...
			dataSourceDescription.add("example: http://ec2-52-79-168-196.ap-northeast-2.compute.amazonaws.com/connect.php");
